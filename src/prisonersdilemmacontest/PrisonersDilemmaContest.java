...
//        System.out.println(Arrays.toString(game.play()));
        RoundRobinTournament rrt = new RoundRobinTournament(new RandomPrisoner(), new MeanPrisoner(), new NicePrisoner(), new CopyMovePrisonerMean(), new CopyMovePrisonerNice(), new SimonBayesPrisoner(), new FarrarFibPrisoner());
        rrt.runTournament();
    }
}
